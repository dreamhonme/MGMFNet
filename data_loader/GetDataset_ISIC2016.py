...
def ISIC2016_transform_newdata(sample, train_type):
...
class ISIC2016_dataset(Dataset):
    def __init__(self, dataset_folder='/ISIC2016_npy_256_256',
                 folder='folder0', train_type='train', with_name=False, transform=ISIC2016_transform_newdata):
        folder='folder'+str(folder)
        self.transform = transform
        self.train_type = train_type
        self.with_name = with_name
        self.folder_file = './data_loader/isic_datalist2016/' + folder
