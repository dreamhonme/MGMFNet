...
def ISIC2017_transform_newdata(sample, train_type):
...
class ISIC2017_dataset(Dataset):
    def __init__(self, dataset_folder='/ISIC2017_npy_224_320',
                 folder='folder0', train_type='train', with_name=False, transform=ISIC2017_transform_newdata):
        folder='folder'+str(folder)
        self.transform = transform
        self.train_type = train_type
        self.with_name = with_name
        self.folder_file = './data_loader/isic_datalist2017/' + folder
